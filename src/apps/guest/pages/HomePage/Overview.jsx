  ...
  return (
    <div className="flex-grow bg-[#f2f2f2] rounded-2xl shadow-lg overflow-hidden flex flex-col font-sans text-[#1f1f1f] h-auto lg:h-[530px]">
      ...
      <div className="relative group shrink-0">
        ...
        <Link
          to="/product"
          className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-1/2 z-20 bg-[#1f1f1f] text-white rounded-[4px] px-6 py-3 flex items-center gap-2 text-xs hover:bg-black transition shadow-lg border border-[#333]"
        >
          <span>Bid Now</span>
          <svg
            xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="flex flex-col md:flex-row w-full h-full">
        ...
        <div className="w-full md:w-1/2 border-b-2 md:border-b-0 md:border-r-2 border-dashed border-[#ccc] flex flex-col relative">
          <div className="p-6 md:p-8 pt-8 md:pt-12 pr-6 flex flex-col h-full justify-start">
            <div className="flex flex-wrap gap-2.5 mb-4">
              <button className="border border-dashed border-gray-400 rounded-lg px-3 py-1.5 md:px-4 md:py-2 bg-transparent font-mono text-[10px] text-gray-600 hover:border-gray-800 transition whitespace-nowrap">
                All
              </button>
              <button className="border border-dashed border-gray-400 rounded-lg px-3 py-1.5 md:px-4 md:py-2 bg-transparent font-mono text-[10px] text-gray-600 hover:border-gray-800 transition whitespace-nowrap">
                Mens
            ...
            <h2
              className="font-bold text-xl md:text-2xl mb-1 uppercase tracking-tight truncate w-full"
        ...
        <div className="w-full md:w-1/2 grid grid-cols-2">
          ...
          <div className="p-4 md:p-6 md:pt-14 flex flex-col items-center justify-center text-center border-b-2 border-dashed border-[#ccc]">
            <span className="font-medium text-xl md:text-2xl mb-1">
              by ***kha
            </span>
