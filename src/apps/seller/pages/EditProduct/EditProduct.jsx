      ...
      <HBox className="gap-8">
        ...
        <VBox className="flex-1 gap-8">
          ...
          <HBox>
            ...
            <button className="px-6 py-3 bg-lightGray font-semibold rounded-lg shadow-lg">
              Delete
            </button>
            <button className="px-6 py-3 bg-primary text-white font-semibold rounded-lg shadow-lg">
              Save & Publish
            </button>
          </HBox>
        </VBox>
