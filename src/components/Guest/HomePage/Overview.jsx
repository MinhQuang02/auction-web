    ...
    return (
        <div className="flex-grow bg-[#f2f2f2] rounded-2xl shadow-lg overflow-hidden flex flex-col font-sans text-[#1f1f1f]">
            ...
            <div className="relative group shrink-0">
                ...
                {/* Bid Now Button */}
                <Link to="/product" className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-1/2 z-20 bg-[#1f1f1f] text-white rounded-[4px] px-6 py-3 flex items-center gap-2 text-xs hover:bg-black transition shadow-lg border border-[#333]">
                    <span>Bid Now</span>
