...
const OngoingAuctions = () => {
    ...
    return (
        <section id="ongoing-auctions" className="container mx-auto px-5 lg:px-12 py-10">
            {/* Header Section */}
            <div className="flex justify-between items-end mb-10">
                <div>
                    ...
                    <h2 className="text-3xl md:text-4xl font-semibold tracking-wide">Ongoing Auctions</h2>
                </div>
                ...
                {products.map((product) => (
                    <div key={product.id} className="flex-none w-[270px] snap-center">
                        ...
                        <div className="flex gap-3 items-center mb-2">
                            <span className="text-primary font-medium">{product.currentBid}</span>
