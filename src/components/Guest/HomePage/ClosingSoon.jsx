...
const ClosingSoon = () => {
    ...
    return (
        <section id="closing-soon" className="py-10 relative w-full overflow-hidden">
            <div className="container mx-auto px-5 lg:px-12 relative">
                ...
                <div className="mb-14 relative z-10">
                    ...
                    <h2 className="text-3xl md:text-4xl font-semibold tracking-wide">Top 5 Closing Soon</h2>
                </div>
