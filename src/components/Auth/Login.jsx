...
const Login = () => {
    ...
    const onlineImage = "https://images.unsplash.com/photo-1490481651871-ab68de25d43d?q=80&w=2070&auto=format&fit=crop";
            ...
            <div className="w-full h-full max-w-[1600px] flex gap-10 lg:gap-20 bg-white lg:bg-transparent rounded-[32px] lg:rounded-none shadow-xl lg:shadow-none overflow-hidden min-h-[600px]">
                ...
                <div className="w-full lg:w-5/12 flex flex-col justify-center px-8 py-10 md:px-12 lg:pl-16 lg:pr-0">
                    <div className="w-full max-w-[400px] mx-auto lg:mx-0">
                        ...
                        <p className="text-gray-400 text-sm mb-10">Please login to continue to your account.</p>
                        ...
                        <form className="flex flex-col gap-5" onSubmit={(e) => e.preventDefault()}>
                            ...
                            <div className="relative">
                                <input 
                                    type="email" 
                                    defaultValue="mphanquang06@gmail.com"
                            ...
                            <div className="flex items-center justify-between mt-1">
                                <div className="flex items-center gap-2">
                                    <input type="checkbox" id="keep-logged" className="w-4 h-4 border-2 border-black rounded-sm bg-transparent accent-black cursor-pointer" />
                                    <label htmlFor="keep-logged" className="text-xs font-medium text-black cursor-pointer select-none">Keep me logged in</label>
                                </div>
                                
                                <Link to="/forgot-password" className="text-xs font-medium text-[#AD9C86] hover:text-[#8E7C68] hover:underline transition-colors">
                                    Forgot Password?
                                </Link>
                            </div>
                            ...
                            <button type="button" className="w-full h-[50px] bg-[#E6E4E1] hover:bg-[#dcdad7] text-black font-medium rounded text-sm transition flex items-center justify-center gap-2">
                            ...
                            <div className="text-center text-sm text-gray-500 mt-4">
                                Need an account? <Link to="/signup" className="underline decoration-1 underline-offset-2 hover:text-black transition">Create one</Link>
                            </div>
                        </form>
                    </div>
                </div>
