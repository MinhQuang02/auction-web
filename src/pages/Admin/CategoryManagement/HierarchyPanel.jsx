...
const HierarchyPanel = ({ data, onSelect, selectedIds = [], onToggleActive }) => {
  return (
...
const CategoryRow = ({ item, level, onSelect, selectedIds, onToggleActive }) => {
  ...
  return (
    <>
      ...
      {hasChildren && expanded && (
        <motion.div layout initial={false} animate={{ height: expanded ? "auto" : 0 }} className="overflow-hidden">
