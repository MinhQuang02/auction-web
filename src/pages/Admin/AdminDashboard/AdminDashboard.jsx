...
import StatsCell from "components/Admin/Hero/StatsCell";
import Panel from "components/Shared/Panel";
import FilterButton from "components/Shared/IconButton/FilterButton";
import TablePanel from "components/Shared/TablePanel";

const activityTabs = ["System Activity", "User Activity", "Marketplace Activity"];
    ...
    <VBox className="p-10 gap-40">
      <HBox className="gap-10">
        ...
        <HBox className="w-full">
          <StatsCell number={100000} label="Total Users" className="flex-1 h-full" />
          <StatsCell number={100000} label="Active Users" className="flex-1 h-full" />
          <StatsCell number={100000} label="Total Auctions" className="flex-1 h-full" />
          <StatsCell number={100000} label="Active Auctions" className="flex-1 h-full" />
        </HBox>
      </HBox>

      <VBox>
        <span className="text-4xl font-semibold text-black">Recent Activity</span>
        <span className="h-1" />
