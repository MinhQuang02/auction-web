...
const Signup = () => {
    ...
    const onlineImage = "https://images.unsplash.com/photo-1476820865390-c52aeebb9891?q=80&w=2670&auto=format&fit=crop";
            ...
            <div className="w-full h-full max-w-[1600px] flex gap-10 lg:gap-20 bg-white lg:bg-transparent rounded-[32px] lg:rounded-none shadow-xl lg:shadow-none overflow-hidden min-h-[600px]">
                ...
                <div className="w-full lg:w-5/12 flex flex-col justify-center px-8 py-10 md:px-12 lg:pl-16 lg:pr-0">
                    <div className="w-full max-w-[450px] mx-auto lg:mx-0">
                        ...
                        <p className="text-gray-400 text-sm mb-8">Sign up to enjoy the feature of Style.Loom</p>
                        ...
                        <form className="flex flex-col gap-4" onSubmit={(e) => e.preventDefault()}>
                            ...
                            <div className="relative">
                                <input 
                                    type="text" 
                                    defaultValue="227, Nguyen Van Cu" 
                                    className="w-full h-[50px] bg-transparent border border-gray-300 rounded px-4 text-sm outline-none text-black focus:border-[#A3907B]"
                                />
                                <label className="absolute -top-2.5 left-3 bg-white lg:bg-[#F4F4F4] px-1 text-xs text-gray-400">
                                    Address
                            ...
                            <div className="relative">
                                <input 
                                    ...
                                    className="w-full h-[50px] bg-transparent border border-[#A3907B] rounded px-4 text-sm outline-none text-black focus:ring-1 focus:ring-[#A3907B]"
                                />
                                <label className="absolute -top-2.5 left-3 bg-white lg:bg-[#F4F4F4] px-1 text-xs font-medium text-[#A3907B]">
                                    Email
                                </label>
                            </div>
                            ...
                            <div className="text-center text-sm text-gray-500 mt-4">
                                Already have an account? <Link to="/login" className="underline decoration-1 underline-offset-2 hover:text-black transition">Sign in</Link>
                            </div>
